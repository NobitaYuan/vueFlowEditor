  ...
  <baseNodeTemplate v-bind="Props" :defaultLabel="false">
    <div class="event_start">
      <div class="innerBorder">
        <svgIcon class="icon" :name="customShape.event_compensation_boundary" />
      </div>
...
.event_start {
  ...
  width: 100%;
  height: 100%;
  border: 1px solid var(--color-boundary-event);
  border-radius: 50%;
  ...
  .innerBorder {
    ...
    .icon {
      color: var(--color-boundary-event);
    }
  }
  .label {
    position: absolute;
